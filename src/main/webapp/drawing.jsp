			    ...
			    <div class="circles_wrap" style="width:190px">
				  ...
				  <div class="display_table_fixed">
					  <div class="single_shape_select_div" id="sss_round">
					         <img class="smb_img_img sss_baw"  id="sss_round_baw" src="img/transparent.png" />
							 <img class="smb_img_img sss_col" id="sss_round_col" src="img/transparent.png" style="display:none"/>
					  </div>
					  <div class="single_shape_select_div" id="sss_circle">
					     <img class="smb_img_img sss_baw"  id="sss_circle_baw"  src="img/transparent.png"/>
						 <img class="smb_img_img sss_col" id="sss_circle_col" src="img/transparent.png" style="display:none"/>
					  </div>
					  <div class="single_shape_select_div" id="sss_trapex">
					     <img class="smb_img_img sss_baw"  id="sss_trapex_baw"  src="img/transparent.png"/>
						  <img class="smb_img_img sss_col" id="sss_trapex_col" src="img/transparent.png" style="display:none"/>
					  </div>
					  <div class="single_shape_select_div" id="sss_rect">
					     <img class="smb_img_img sss_baw"  id="sss_rect_baw"  src="img/transparent.png"/>
						 <img class="smb_img_img sss_col" id="sss_rect_col" src="img/transparent.png" style="display:none"/>
					  </div>
				  </div>
				</div>
				<div class="circles_wrap"  style="width:90px">
				  ...
				  <div class="display_table_fixed">
					  <div class="single_shape_select_div" id="sss_line">
					    <img class="smb_img_img  sss_baw"  id="sss_line_baw" src="img/transparent.png"/>
						 <img class="smb_img_img  sss_col" id="sss_line_col" src="img/transparent.png" style="display:none"/>
					  </div>
					  <div class="single_shape_select_div" id="sss_text">
					     <img class="smb_img_img sss_baw"  id="sss_text_baw"  src="img/transparent.png"/>
						 <img class="smb_img_img sss_col" id="sss_text_col" src="img/transparent.png" style="display:none"/>
					  </div>
				  </div>
				</div>
				<div class="circles_wrap"  style="width:190px">
				  ...
				  <div class="display_table_fixed">
					  <div class="single_shape_select_div" id="sss_table">
					     <img class="smb_img_img sss_baw" id="sss_table_baw" src="img/transparent.png"/>
						 <img class="smb_img_img sss_col" id="sss_table_col" src="img/transparent.png" style="display:none"/>
					  </div>
					  <div class="single_shape_select_div" id="sss_chair">
					     <img class="smb_img_img sss_baw" id="sss_chair_baw" src="img/transparent.png"/>
						 <img class="smb_img_img sss_col" id="sss_chair_col" src="img/transparent.png" style="display:none"/>
					  </div>
					  <div class="single_shape_select_div" id="sss_combo">
					      <img class="smb_img_img sss_baw" id="sss_combo_baw" src="img/transparent.png"/>
						  <img class="smb_img_img sss_col" id="sss_combo_col" src="img/transparent.png" style="display:none"/>
					  </div>
				  </div>
				</div>
				<div class="circles_wrap"  style="width:90px">
				  ...
				  <div class="display_table_fixed">
					<div class="single_shape_select_div" id="sss_user">
					   <img class="smb_img_img sss_baw" id="sss_user_baw"  src="img/transparent.png"/>
					   <img class="smb_img_img sss_col" id="sss_user_col" src="img/transparent.png" style="display:none"/>
					</div>
				  </div>
				</div>
			   </div>
