...
endShowTime = $("#datepicker_fe").datepicker( "getDate" ).getTime()+days_*24*3600*1000;
...
$("#from_margin_div").hide();
 ...
 var width =  document.getElementById("bookings_ub_wrap_main").offsetWidth;
 $("#bookings_fe_wrap").css("width",width-6);
 ...
 $("#selected_outer").css("width",canvasw-12);
	 rangeSliderInitial = true;
	 updateTimeSteps();
}
function booking400Width() {
			...
			$("#to_margin_div").hide();
 $("#bookings_ub_wrap_main").removeClass("booking_wrap_main_w");
