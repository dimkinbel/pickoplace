...
function updatePageView() {
  ...
  <table id="body_table"  cellspacing="0" cellpadding="0" style="width:100%;height:100%;border-collapse:collapse">
      ...
      <div id="messagesInner">
        ...
        <div class="outer_width100" >
       	 ...
       	 <div class="creatingTourText">
        	  <span class="steps"></span> Editing Place : <span class="placeNamespan">       	          
        	 ...
        	 <input type="text" id="server_Address" name="userSetPlaceBName" value='<%=responseJSON.getAddress() %>' style="display:none"/>
        	 <input type="text" id="server_Lat" name="userSetPlaceBName" value='<%=responseJSON.getLat()%>' style="display:none"/>
        	 <input type="text" id="server_Lng" name="userSetPlaceBName" value='<%=responseJSON.getLng()%>' style="display:none"/>
   ...
   <%} %>	  
		...
		<table id="tour_buttons_table">
		 <tr>
		  <td style="position:relative">
		    <div id="drawingSaveButton"  onclick="SIupdateSaveObjectPre()">Save</div>
		    <img id="saveplase_ajax_gif" src="/js/728.GIF" style="display:none"/>
		  </td>
		  <td>
		    <div id="drawingConfigButton"  onclick="SIPlaceConfiguration('<%=placeID%>')">Continue</div>
		...
		<button onclick="alertCS()">alert canvas</button>
					...
					<tr>
		              <td>
					    <table  cellspacing="0" cellpadding="0" style="width:95%;height:100%;border-collapse:collapse;margin-left: 5px;">
						 ...
						 <tr>
						  <td class="cdnd-td"><div id="cd-label">current day</div></td>
						  <td class="cdnd-td"><div id="nd-label">next day</div></td>
						 </tr>
						</table>						
		              </td>
					</tr>
									   ...
									   <tr><td class="option_font"> Font family </td>
									       <td>
												<select  class="font_selectors"  id="selected_font__selector">
												  <option value="Varela, sans-serif" >Varela</option>
