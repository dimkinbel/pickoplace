...
public class PlaceWeekOpenClose {
	WeekDayOpenClose sun;
	WeekDayOpenClose mon;
	WeekDayOpenClose tue;
	WeekDayOpenClose wed;
	WeekDayOpenClose thu;
	WeekDayOpenClose fri;
	WeekDayOpenClose sat;
